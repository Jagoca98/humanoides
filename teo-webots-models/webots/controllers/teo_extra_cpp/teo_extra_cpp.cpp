...
int main(int argc, char **argv)
{
  ...
  // __3__
  double target0_q0 = radians(45); // use helper: radians()
  double target0_q1 = radians(45); // use helper: radians()
  double target0_q2 = radians(14);
  double target1_q2 = radians(-45);
  motor_q0->setPosition(target0_q0);
  motor_q1->setPosition(target0_q1);
  motor_q2->setPosition(target0_q2);
  robot->step(1000);
  mySleep(1000);
  ...
  // __4a__
  double target1_x = target0_x-0.1;
  double target1_z = target0_z+0.2;
  ...
  // __4b__
  double target2_x = target0_x-0.1;
  double target2_z = target0_z;
  ...
  // __4c__
  double target3_x = target0_x-0.1;
  double target3_z = target0_z-0.2;
  ...
  while(true)
  {
    ...
    motor_q2->setPosition(target1_q2);
    if(-1 == robot->step(1000))
        break;
    mySleep(1000);
    motor_q0->setPosition(target2_q0);
